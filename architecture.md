...
**Step 5 is a Python guard, not a prompt instruction.** A 7B model handed weak context will confabulate regardless of what the system prompt asks of it. `RETRIEVAL_FLOOR` is tuned against the five out-of-corpus evaluation questions and is the mechanism behind acceptance criterion AC3.
